...
//private let repoDescription: String? = "https://api.themoviedb.org/3/movie/now_playing?api_key=a07e22bc18f5cb106bfe4cc1f83ad8ed"  // 1. Add a repoDescription field to the GithubRepo model to represent a repository's description.
...
class GithubRepo: CustomStringConvertible {
    ...
    var stars: Int?
    var forks: Int?
    var details: String? // add for mile stone 2 variable
    ...
    init(jsonResult: NSDictionary) {
        ...
        // mile stone 2 add "description"
        if let details = jsonResult["description"] as? String? {
